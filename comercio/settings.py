...
SECRET_KEY = 'django-insecure-zr8h0zfr1#!(-^z0t-juc$4v7wjo_gh!mif!06-ih$r+*wc@$^'
...
INSTALLED_APPS = [
    ...
    'producto.apps.ProductoConfig', # <---AGREGAR NUEVAS APLICACIONES ACA!!!
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'producto/templates') # <---AGREGAR NUEVAS PLANTILLAS ACA!!!
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
